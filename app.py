...
<div style="background:#0e0f1a;border:1px solid #1c1d30;border-radius:14px;padding:1.4rem 1.6rem;">
    <div style="font-size:1.3rem;font-weight:700;color:#d0d1e8;margin-bottom:0.4rem;">📝 Text Detection</div>
    <div style="font-family:'DM Mono',monospace;font-size:0.68rem;color:#44456a;line-height:1.7;">Bidirectional LSTM · GPT-4o humanizer</div>
</div>
<div style="background:#0e0f1a;border:1px solid #1c1d30;border-radius:14px;padding:1.4rem 1.6rem;">
